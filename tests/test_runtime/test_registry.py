"""Tests for kanibako.runtime.registry: OCI digest client (all network mocked)."""
...
class TestGetAnonymousToken:
    def test_ghcr_returns_token(self):
        ...
        with patch("kanibako.runtime.registry.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_url_construction(self):
        ...
        with patch("kanibako.runtime.registry.urllib.request.urlopen", return_value=mock_resp) as m:
...
class TestGetRemoteDigests:
    ...
    def test_index_returns_tag_and_matching_child(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value="tok"),
            patch("kanibako.runtime.registry.urllib.request.urlopen",
    ...
    def test_plain_manifest_returns_tag_only(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value=None),
            patch("kanibako.runtime.registry.urllib.request.urlopen",
    ...
    def test_failure_returns_empty_set(self):
        with patch("kanibako.runtime.registry._parse_image_ref", side_effect=OSError("boom")):
...
class TestListRemoteTags:
    def test_returns_tag_list(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value="tok"),
            patch("kanibako.runtime.registry.urllib.request.urlopen", return_value=body) as m,
        ):
    ...
    def test_filters_non_strings(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value=None),
            patch("kanibako.runtime.registry.urllib.request.urlopen", return_value=body),
        ):
    ...
    def test_network_error_returns_empty(self):
        with patch("kanibako.runtime.registry._parse_image_ref", side_effect=OSError("x")):
            assert list_remote_tags("ghcr.io/o/r:latest") == []
...
class TestGetRemoteTagDigest:
    def test_overrides_tag(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value="tok"),
            patch("kanibako.runtime.registry.urllib.request.urlopen", return_value=head) as m,
        ):
...
class TestGetRemoteCreated:
    def test_index_resolves_child_then_config(self):
        ...
        with (
            patch("kanibako.runtime.registry._get_anonymous_token", return_value="tok"),
            patch(
                "kanibako.runtime.registry.urllib.request.urlopen",

...
> Seeded or mounted from workset playbook (`~/playbook/workset/directives/BRIEF_WORKSET.md`).
...
What ties these projects together - Shared tooling, common domain, cross-project dependencies

---

## Shared Conventions

Rules applying across all projects in this workgroup: naming, shared libraries, API contracts, auth

---

## Cross-Project Notes

Dependencies between projects, integration points, shared state

---

## Projects

List of projects in this workgroup with brief descriptions

| Project | Description |
|---------|-------------|
| fancy_feast | tasty morsels |
